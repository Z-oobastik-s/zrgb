    ...
    return (
      <li key={row.id}>
        ...
        >
          ...
          <span className="min-w-0 flex-1 truncate text-xs leading-snug text-accent/95 sm:text-[13px]">
            {label}
          </span>
          <span
            className="shrink-0 tabular-nums text-[10px] text-muted sm:text-[11px]"
